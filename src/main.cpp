...
// configuration step. It creates a namespace called `following_along`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        following_along::cmake::project_name,
        following_along::cmake::project_version));// version string, acquired
